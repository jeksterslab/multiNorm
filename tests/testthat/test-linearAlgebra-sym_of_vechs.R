...
testthat::test_that("sym_of_vechs works", {
...
testthat::test_that("sym_of_vechs works 2 by 2", {
  testthat::expect_equal(
    result_i,
    answer_i
  )
...
testthat::test_that("sym_of_vechs works random cov", {
  testthat::expect_equal(
    result_i,
    answer_i
  )
...
# expect_error
testthat::test_that("sym_of_vechs error", {
